...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center mx-auto">
    ...
    <form method="post" name="form1" action="{{ route('kafedry_add') }}">
      @csrf
      <div class="form-group">
        <label for="nazva_kafedry">Назва кафедри</label>
        <input type="text" class="form-control" name="nazva_kafedry" placeholder="Введіть назву кафедри">
      </div>
      <div class="form-group">
        <label for="roztashuvannya">Розташування</label>
        <input type="text" class="form-control" name="roztashuvannya" placeholder="Введіть розташування кафедри">
      </div>
