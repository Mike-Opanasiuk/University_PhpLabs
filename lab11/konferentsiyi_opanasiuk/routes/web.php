...
Route::middleware('guest')->namespace('\App\Http\Controllers')->group(function () {
    ...
    Route::post('/login', 'user_controller@postSignin');
});
...
Route::post('/reg', 'App\Http\Controllers\user_controller@postReg');
...
Route::group(['middleware' => ['auth']], function () {
    Route::get('/logout', 'App\Http\Controllers\user_controller@perform');
});
